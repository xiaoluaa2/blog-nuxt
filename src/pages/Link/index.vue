    ...
    <div class="linkPage">
      ...
      <div class="site-card-group">
        <div @click="goLink(item.author_link)" v-for="item in friendList" class="site-card">
          <card-2>
            ...
            <template v-if="item.author_siteshot" v-slot:back>
              <div class="back">
                <img :src="item.author_siteshot" :alt="item.author_descr" />
              </div>
            </template>
            <template v-else v-slot:back>
              <div class="frot">
                <img :src="item.author_avatar" :alt="item.author_name" />
                <div class="auth-name">{{ item.author_name }}</div>
                <div class="auth-content">{{ item.author_descr }}</div>
      ...
      <figure class="plaintext">
        <div class="highlight-tools">
          ...
          <div class="code-lang">
            PLAINTENT
            <svg @click="copy" t="1700721041298" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2735" width="200" height="200">
              <path d="M866.304 907.264H461.824l-40.96-40.96V664.576h81.92v160.768h322.56V502.784H664.576v-81.92h201.728l40.96 40.96v404.48z" fill="#437DFF" p-id="2736"></path>
              <path d="M334.39744 377.86624L377.856 334.4384 421.2736 377.856 377.856 421.31456zM434.83136 478.03392l43.43808-43.44832 43.44832 43.44832-43.44832 43.44832zM535.25504 578.2016l43.44832-43.44832 43.43808 43.44832-43.43808 43.43808z" fill="#63F7DE" p-id="2737"></path>
              <path d="M359.424 603.136H157.696l-40.96-40.96V157.696l40.96-40.96h404.48l40.96 40.96v201.728h-81.92V198.656H198.656v322.56h160.768z" fill="#437DFF" p-id="2738"></path>
            </svg>
          </div>
        ...
        <figcaption style="display: block; padding: 0.5rem 0"><span>我的信息:</span></figcaption>
...
.linkPage {
  ...
  animation: slide-in 0.5s 0.1s backwards;
  -webkit-animation: slide-in 0.5s 0.1s backwards;
  border-radius: 18px;
  padding: 10px 35px;
