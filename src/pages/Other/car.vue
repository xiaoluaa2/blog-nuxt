...
let car_light_sphere: any[] = [],
  car_light_spotLight: any[] = []
...
let run = () => {
  ...
  road.children[1].position.x = (time % 1) + 0.5
...
let cheshen = [
  [8, 10, 34, 36, 38, 90, 88, 238, 451, 454, 457, 460, 36, 92, 'Object_139_10', 'Object_155_11'],
  [2, 4, 8, 10, 12, 26, 30, 34, 36],
  [56, 60, 62, 64, 66, 68, 70, 58]
]
let lungu = [
  [409, 411, 419, 412, 414, 421, 422, 424, 433, 431, 434, 436, 441, 436, 446, 447],
  [160, 158, 156, 154, 162, 168, 171, 165],
  [4, 8, 9, 22, 17, 31, 41, 21, 30, 31, 37, 41, 13, 45, 46, 52]
]
        ...
        if (door.right.open) {
          door.right.list.forEach((obj: any) => {
            ...
            tween
              ...
              .onUpdate(function (lastLocation: any) {
