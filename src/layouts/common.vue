      ...
      <div v-show="showCatalogue" class="card-widget">
        <div class="catalogue shadow-box">
          ...
          <div class="catalogue_item" v-for="(item, index) in titleList" :key="item.indent">
            ...
            <div v-if="item.indent == 2" @click="jump_location(index)" :class="heightTitle == index ? 'active_catalogue' : ''" class="catalogue_content">
              {{ item.title }}
            </div>
          </div>
        </div>
            ...
            <div class="gif">
              <div class="vader">
                ...
                <div class="torso">
                  ...
                  <div class="plate"><span class="red_top"></span><span class="red_center"></span><span class="red_bottom"></span><span class="blue"></span><span class="gray"></span></div>
                </div>
